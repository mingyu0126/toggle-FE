...
public class StoreService {
    ...
    public ResolveStoreResponse resolveStore(ResolveStoreRequest request) {
        ...
        Store store = storeRepository.findByExternalSourceAndExternalPlaceId(source, request.externalPlaceId())
    ...
    private ExternalSource parseExternalSource(String source) {
        try {
            return ExternalSource.valueOf(source.toUpperCase(Locale.ROOT));
